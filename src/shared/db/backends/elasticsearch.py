...
Wraps elasticsearch-py client to conform to the SearchClient protocol.
Optional — only used when config.search_backend.type == "elasticsearch".
"""
...
class ElasticSearchClient:
    """SearchClient implementation backed by Elasticsearch."""
    ...
    def mget(
        ...
        kwargs: dict[str, Any] = {"index": index, "ids": ids}
        if source is not None:
            kwargs["_source"] = source
