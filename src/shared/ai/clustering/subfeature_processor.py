"""Subfeature processor - sub-cluster large features and process them.

Processes subfeatures within large feature clusters:
1. Identify large features (>20 members)
2. Sub-cluster members using HDBSCAN
3. Label sub-clusters
4. Summarize and embed each subfeature
5. Index subfeature documents to ES
"""
...
class SubfeatureTimingStats:
    ...
    def record(
        ...
        """Record timing and token usage for a completed subfeature."""
        with self._lock:
