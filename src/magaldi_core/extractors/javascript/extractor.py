...
class JavaScriptExtractor(BaseExtractor):
    ...
    def extract_elements(self, tree: Tree, lines: list[str]) -> list[ExtractedElement]:
        ...
        return extract_javascript_elements(tree, lines)  # type: ignore[no-any-return]
    ...
    def extract_class_members(
        ...
        return extract_javascript_class_members(class_node, lines)  # type: ignore[no-any-return]
    ...
    def extract_imports(self, tree: Tree, lines: list[str]) -> list[ExtractedImport]:
        ...
        return extract_javascript_imports(tree, lines)  # type: ignore[no-any-return]

    def extract_references(
        self, tree: Tree, lines: list[str]
    ) -> list[ExtractedReference]:
        """Extract all references from JavaScript/TypeScript AST."""
        return extract_javascript_references(tree, lines)  # type: ignore[no-any-return]
